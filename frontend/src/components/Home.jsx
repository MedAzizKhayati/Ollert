...
export default () => {
    ...
    React.useEffect(() => {
        axios.get('/users/list/' + rows + '/' + page).then(users => {
            setUsers(users.data);
        })
    }, [page]);
        ...
        <div id='Home' className='container'>
            ...
            <nav style={{cursor: 'pointer'}}>
                <ul class="pagination pagination-sm justify-content-end">
                    <li class="page-item"><a class="page-link" onClick={() => handleClick(-1)}>Previous</a></li>
                    <li class="page-item"><a class="page-link" onClick={() => handleClick(1)}>Next</a></li>
                </ul>
            </nav>
            <table class="table">
                <thead>
